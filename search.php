                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-outline-success" href="preview.php?stud_id=<?php echo $row['stud_id'] ?>&name=<?php echo $row['name'] ?>&birthdate=<?php echo $row['birthdate'] ?>&level=<?php echo $row['level'] ?>&year=<?php echo $row['year'] ?>">
